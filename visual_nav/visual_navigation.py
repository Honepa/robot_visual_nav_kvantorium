...
ax,bx,cx = [9.820005114983567e-05, 3.2119685364295094, 124.6708974253563]
ay,by,cy = [-0.00038451651106817926, 4.986738173495477, 16.26600602205911]
...
class VisualNav():
    ...
    def get_frames(self, id, n=4):
        ...
        for i in range(n):
            ...
            img = np.array(np.rot90(np.rot90(frame.astype(np.uint8))))
    ...
    def draw_circles(self, objects):
        for object in objects:
            r_min = object['distance'].X - object['distance'].Dx
            r_max = object['distance'].X + object['distance'].Dx
            c = (object['X'],object['Y'])
            circle = [{
                'c': c,
                'r_min': r_min,
    ...
    def calculate_my_coords(self):
        ...
        except NotEnoughValuesException as e:
